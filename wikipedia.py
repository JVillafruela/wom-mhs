...
# source random user-agent: http://edmundmartin.com/random-user-agent-requests-python/
...
def extrait_infos(datas):
    ...
    if isinstance(datas[0].find('a'), bs4.element.Tag) and datas[0].find('a', href=re.compile('^#cite_note')) is None:
        ...
        if "page inexistante" in tag_wk:
            ...
            tag_wk = ''
    elif datas[0].find('a') is None or datas[0].find('a', href=re.compile('^#cite_note')) is not None:
        nom = datas[0].text
...
def ajoute_infos(infos, musee):
    ...
    if (infos[0] in musee.collection) and (infos[0] in musee.collection[infos[0]].description) and (musee.collection[infos[0]].description[infos[0]]['wip'] != {}):
        ...
        if 'mhs_bis' in musee.collection[infos[0]].description[infos[0]]['wip']:
            musee.collection[infos[0]].description[infos[0]]['wip']['mhs_ter'] = {
                'insee': infos[1],
                'commune': infos[2],
                'nom': infos[3],
                'geoloc': infos[4],
            ...
            musee.collection[infos[0]].description[infos[0]]['wip']['mhs_bis'] = {
                'insee': infos[1],
                'commune': infos[2],
                'nom': infos[3],
                'geoloc': infos[4],
