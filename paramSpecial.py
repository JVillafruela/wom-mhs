...
special = {
    ...
    '21': {'url': [
        "de_la_Côte-d'Or_(A-L)",
        "de_la_Côte-d'Or_(M-Z)"]
    },
    '22': {'url': [
        "des_Côtes-d'Armor_(A-O)",
        "des_Côtes-d'Armor_(P-Z)"]
    },
    '24': {'url': [
        "de_l'arrondissement_de_Bergerac",
    ...
    '31': {'url': [
        "de_la_Haute-Garonne_(A-L)",
        "de_la_Haute-Garonne_(M-Z)"]
    },
    '33': {'url': [
        "de_l'arrondissement_d'Arcachon",
    ...
    '37': {'url': [
        "d'Indre-et-Loire_(A-J)",
        "d'Indre-et-Loire_(K-Z)"]
    },
    '39': {'url': [
        "du_département_du_Jura",
        "d'Arbois",
        "de_Dole",
        "de_Lons-le-Saunier",
        "de_Salins-les-Bains"]
    ...
    '43': {'url': [
        "de_la_Haute-Loire_(ouest)",
        "de_la_Haute-Loire_(est)"]
    },
    '44': {'url': [
        'de_la_Loire-Atlantique',
        "de_Nantes"]
    },
    '45': {'url': [
        'du_Loiret',
    ...
    '49': {'url': [
        "de_Maine-et-Loire_(nord)",
        "de_Maine-et-Loire_(sud)",
        "d'Angers",
        "de_Saumur"]
    },
    '50': {'url': [
        "de_l'arrondissement_de_Saint-Lô",
    ...
    '56': {'url': [
        "de_l'arrondissement_de_Lorient",
    ...
    '64': {'url': [
        "des_Pyrénées-Atlantiques_(A-L)",
        "des_Pyrénées-Atlantiques_(M-Z)"]
    },
    '66': {'url': [
        "des_Pyrénées-Orientales",
        "de_Perpignan",
    ...
    '75': {'url': [
        "du_1er_arrondissement_de_Paris",
